       ...
       <div>
           <asp:Table ID="Table1" runat="server" Style="margin-top: 50px;" GridLines="Both" CellSpacing="200" CellPadding="15">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>Landing page with buttons to navigate to staff, member page and application summary table</asp:TableCell>
               ...
               <asp:TableRow>
                      <asp:TableCell>Khushi</asp:TableCell>
                      <asp:TableCell>Staff Page</asp:TableCell>
               ...
               <asp:TableRow>
                   <asp:TableCell>Khushi</asp:TableCell>
                   <asp:TableCell>Member Page</asp:TableCell>
